...
// uses super agent to handle the server calls and wraps them in a promise to ensure they are not blocking other processes
function read() {
    return new Promise((resolve, reject) => {
        var url = '/data';
        superagent
...
function App() {
    // defines the data we will be using
